...
public class OpenHtmlToPdfConsumer extends DefaultConsumer {
    private final OpenHtmlToPdfEndpoint endpoint;
    private final EventBusHelper eventBusHelper;

    private ExecutorService executorService;

    public OpenHtmlToPdfConsumer(OpenHtmlToPdfEndpoint endpoint, Processor processor) {
